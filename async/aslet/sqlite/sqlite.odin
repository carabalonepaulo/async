...
Open_Flag :: enum c.int {
	...
	Extended_Result_Code = 0x02000000,
}
...
foreign sqlite {
	...
	open_v2 :: proc "c" (filename: cstring, db: ^^Connection, flags: Open_Flag, z_vfs: cstring) -> Result_Code ---
	...
	column_type :: proc "c" (statement: ^Statement, col_idx: c.int) -> Column_Type ---
